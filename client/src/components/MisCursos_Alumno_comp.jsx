      ...
      <div className="p-3 sm:p-4 flex-1 flex flex-col justify-between min-h-0">
        ...
        <div className="flex-shrink-0">
          <button
            ...
            className={`relative w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-xs sm:text-sm text-white shadow-lg hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-300 overflow-hidden
              ${isDashboardButton
                ? isCurrentCourse 
      ...
      <div className="max-w-7xl mx-auto space-y-8 sm:space-y-12">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-sm"
          >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 sm:gap-4 lg:gap-6">
            {sortedActiveCourses && sortedActiveCourses.length > 0 ? (
              ...
              <div className="col-span-full flex flex-col items-center justify-center py-16 sm:py-20 lg:py-24">
                ...
                <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 sm:p-12 lg:p-16 max-w-2xl mx-auto text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-8">
                      <div className="relative inline-block">
                        <div className="w-24 h-24 sm:w-28 sm:h-28 lg:w-32 lg:h-32 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                    ...
                    {/* Títulos y texto */}
                    <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black bg-gradient-to-r from-gray-800 via-gray-600 to-gray-800 bg-clip-text text-transparent mb-4">
                    ...
                    <p className="text-sm sm:text-base text-gray-500 mb-8 leading-relaxed max-w-lg mx-auto">
                    ...
                    {(!isVerified || !hasPaid) && (
                      <div className="mb-8">
                        <button
                          ...
                          className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white rounded-2xl font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-base"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-4 border border-blue-200">
                        ...
                        <p className="text-xs font-semibold text-blue-800">Aprende a tu ritmo</p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-4 border border-purple-200">
                        ...
                        <p className="text-xs font-semibold text-purple-800">Contenido experto</p>
                      </div>
                      ...
                      <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-4 border border-pink-200">
                        ...
                        <p className="text-xs font-semibold text-pink-800">Progreso rápido</p>
                      </div>
                    </div>
                  </div>
                </div>
