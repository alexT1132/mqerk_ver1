      ...
      <div className="flex bg-white rounded-xl p-1 shadow-lg border border-gray-200">
        ...
        {activeTab === 'current' ? (
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-3 sm:p-4 md:p-5 text-white shadow-xl border border-gray-100">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-800 mb-3 sm:mb-4">Métodos de pago</h3>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 border border-gray-200">
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            ...
            <div className="hidden xl:block">
              <h4 className="font-bold text-gray-800 mb-2">Contacto rápido</h4>
              <div className="space-y-1 text-sm text-gray-600">
                <p>📍 Tuxtepec, Oaxaca</p>
                <p>🕘 Atención: 9:00–17:00 h</p>
                <p>🌐 www.mqerkacademy.com</p>
              </div>
            </div>
          </div>
        </div>
