...
/**
 * Componente PersonalDataSection
 * Muestra la sección de datos personales colapsable con foto de perfil y detalles.
 * 
 * @param {Object} props - Propiedades del componente.
 * @param {Object} props.userData - Datos del usuario (nombre, email, teléfono, etc.).
 * @param {string} props.displayFolio - Folio formateado para mostrar.
 * @param {string} props.reeseProfilePic - URL de imagen de perfil por defecto.
 */
const PersonalDataSection = ({ userData, displayFolio, reeseProfilePic }) => {
  ...
  return (
    <div className="mb-6">
      {/* Botón colapsable con foto y nombre */}
      <button
          ...
          <div className="text-left">
            ...
            {displayFolio && (
              <p className="text-xs text-gray-600 mt-1">
                Folio: <span className="font-bold text-blue-600">{displayFolio}</span>
              </p>
            )}
          </div>
        </div>
