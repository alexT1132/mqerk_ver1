...
export function Configuracion_Alumno_comp() {
    ...
    return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 p-2 xs:p-3 sm:p-4 md:p-5 lg:p-6 text-gray-900 dark:text-gray-100">
        <div className="max-w-[90rem] mx-auto">
                ...
                />
                {/* Header estilo admin */}
                <div className="bg-gradient-to-br from-white via-blue-50 to-indigo-100 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 rounded-xl sm:rounded-3xl shadow-xl shadow-blue-200/30 dark:shadow-black/30 border border-blue-200/50 dark:border-gray-700 p-3 sm:p-5 md:p-6 mb-3 sm:mb-5 backdrop-blur-sm relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center space-x-3 sm:space-x-4">
                            ...
                            <div>
                                <h1 className="text-xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white tracking-tight">
                                    Configuración de Cuenta
                                </h1>
                                <p className="mt-0.5 sm:mt-2 text-xs sm:text-base text-gray-600 dark:text-gray-300 opacity-80">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4">
                    {/* Sidebar de navegación */}
                    <div className="lg:col-span-1">
                        <div className="bg-gradient-to-br from-white via-gray-50 to-blue-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 rounded-xl sm:rounded-3xl shadow-xl shadow-gray-200/40 dark:shadow-black/30 border border-gray-200/50 dark:border-gray-700 p-3 sm:p-5 md:p-6 backdrop-blur-sm relative overflow-visible">
                            <div className="absolute inset-0 bg-gradient-to-tr from-white/30 to-transparent rounded-2xl sm:rounded-3xl"></div>
                    ...
                    <div className="lg:col-span-3 xl:col-span-4">
                        <div className="bg-gradient-to-br from-white via-gray-50 to-blue-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 rounded-xl sm:rounded-3xl shadow-xl shadow-gray-200/40 dark:shadow-black/30 border border-gray-200/50 dark:border-gray-700 p-3 sm:p-5 md:p-6 backdrop-blur-sm relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-tr from-white/30 to-transparent rounded-2xl sm:rounded-3xl"></div>
                    ...
                    {activeTab === 'perfil' && (
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-visible hover:shadow-md transition-all duration-200">
