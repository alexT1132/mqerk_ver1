...
// Mapa centralizado de estilos para áreas y módulos.
// Si en el futuro los colores/iconos vienen de la BD, este archivo se puede
// convertir en adaptador (leer color_gradient/bg_color/icon_key y construir aquí).
