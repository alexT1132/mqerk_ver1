...
import { Layout } from '../components/Layout.jsx'; // El Layout general y flexible
import { Header_Alumno_comp } from '../components/Header_Alumno_comp.jsx'; // El Header de alumno con barra de búsqueda
import { SideBarDesktop_Alumno_comp, SideBarSm_Alumno_comp } from '../components/SideBar_Alumno_Comp.jsx'; // Los SideBars de alumno (plegable y móvil)
