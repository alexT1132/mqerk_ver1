  ...
  return (
    <div className='min-h-screen flex flex-col'>
      ...
      <div className='hidden md:block'>
        <h1 className='text-center mt-10 font-bold text-2xl text-[#401454]'>Ingles, el idioma dominio ante la entrada en vigor del T-MEC</h1>
        ...
        <div className='flex w-full px-8 mt-20 gap-8 mb-6'>
            <div className='flex flex-col w-[60%] gap-10'>
                <div>
                    ...
                    Kelvin Ramírez, Asesor y CEO de MQerKAcademy, junto al Dr. en Educación Hermes Meza, sostuvieron un diálogo centrado en estrategias para fortalecer la enseñanza del inglés en México. Analizaron su impacto en la empleabilidad, la integración al mercado laboral regional y la atracción de inversión extranjera. A través de datos, experiencias y propuestas concretas, destacaron la necesidad de replantear el enfoque actual y promover una educación lingüística más efectiva y contextualizada.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 gap-1 flex flex-col py-5 text-lg">
                        <li className="flex items-center">
                            ...
                            Reflexionar sobre la importancia del inglés como idioma clave para la competitividad en el marco del T-MEC.
                        </li>
                        <li className="flex items-center">
                            <span className="w-2 h-2 bg-black rounded-full mr-3"></span>
                            Identificar los sectores económicos donde el dominio del inglés representa una ventaja estratégica.
                        </li>
                    </ul>
                </div>
            </div>
            <div className="relative w-[35%] h-79 bg-white m-4 p-6">
                ...
                <div className='space-y-3'>
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-md">19 de enero del 2021</p>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-md">24 minutos</p>
                    </div>
                    <div className="flex items-center gap-3">
      ...
      <div className='block md:hidden'>
        <h1 className='text-center mt-25 font-bold text-2xl text-[#401454]'>Ingles, el idioma dominio ante la entrada en vigor del T-MEC</h1>

        <div className="flex justify-center items-center mt-10">
            <div className="w-full max-w-3xl aspect-video flex justify-center">
                <ReactPlayer
                url="https://youtu.be/uWfzE4vgZIs?si=k7VSSbK4xYqIXUji"
                playing
                muted
