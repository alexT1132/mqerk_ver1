  ...
  return (
    <div className='min-h-screen flex flex-col'>
      ...
      <div className='hidden md:block'>
        <h1 className='text-center mt-10 font-bold text-2xl text-[#401454]'>Todas y todos por una educación disruptiva y sostenible</h1>
        ...
        <div className='flex w-full px-8 mt-20 gap-8 mb-6'>
            <div className='flex flex-col w-[60%] gap-10'>
                <div>
                    ...
                    Estudiantes de MQerKAcademy comparten sus perspectivas sobre la educación del futuro.
                    En este video, nuestros alumnos reflexionan sobre la urgencia de transformar los modelos educativos tradicionales hacia un enfoque más disruptivo, inclusivo y sostenible. Abordamos cómo la educación en México necesita adaptarse a los desafíos del siglo XXI, fomentando una enseñanza que sea más creativa y adaptable a las necesidades de todos los estudiantes. 
                    ¡No te pierdas estas ideas frescas y poderosas sobre el cambio que la educación necesita!  
                   </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-2 gap-1 flex flex-col py-5 text-lg">
                        <li className="flex items-center">
                            ...
                            Impulsar el diálogo sobre nuevas formas de enseñanza que rompan con esquemas tradicionales.
                        </li>
                        <li className="flex items-center">
                            <span className="w-2 h-2 bg-black rounded-full mr-3"></span>
                            Promover la equidad y la inclusión en todos los niveles educativos.
                        </li>
                        <li className="flex items-center">
                            <span className="w-2 h-2 bg-black rounded-full mr-3"></span>
                            Incentivar la sostenibilidad como eje transversal en el currículo escolar.
                        </li>
                    </ul>
                </div>
            </div>
            <div className="relative w-[35%] h-79 bg-white m-4 p-6">
                ...
                <div className='space-y-3'>
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-md">Dirigido a: estudiantes y publico en general</p>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <p className="text-md">15 asistentes</p>
                    </div>
                    <div className="flex items-center gap-3">
                        <img src={Sexto} className='w-6' />
                        <p className="text-md">2 minutos</p>
                    </div>
                    <div className="flex items-center gap-3">
      ...
      <div className='block md:hidden'>
        <h1 className='text-center mt-25 font-bold text-2xl text-[#401454]'>Todas y todos por una educación disruptiva y sostenible</h1>
        ...
        <div className="flex justify-center items-center mt-10">
            ...
            <div className='flex flex-col w-full gap-10 px-6 mt-15'>
                <div>
                    ...
                    Estudiantes de MQerKAcademy comparten sus perspectivas sobre la educación del futuro.
                    En este video, nuestros alumnos reflexionan sobre la urgencia de transformar los modelos educativos tradicionales hacia un enfoque más disruptivo, inclusivo y sostenible. Abordamos cómo la educación en México necesita adaptarse a los desafíos del siglo XXI, fomentando una enseñanza que sea más creativa y adaptable a las necesidades de todos los estudiantes. 
                    ¡No te pierdas estas ideas frescas y poderosas sobre el cambio que la educación necesita!                      </p>
                </div>
                <div>
                    <h1 className='font-bold text-2xl'>Objetivos:</h1>
