...
import Uno from "../../../assets/mqerk/Fotos Estudiantes/19.webp";
import Dos from "../../../assets/mqerk/Fotos Estudiantes/20.webp";
import Tres from "../../../assets/mqerk/Fotos Estudiantes/21.webp";
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                En este taller, se compartieron herramientas y reflexiones que ayudaron a los estudiantes a tomar 
                decisiones conscientes sobre su futuro académico y profesional. Desde un enfoque psicoeducativo, se 
                abordaron temas como el autoconocimiento, la toma de decisiones, la identificación de intereses, 
                habilidades y valores personales, así como la importancia de alinear la vocación con el bienestar 
                emocional y el proyecto de vida.
              </p>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up" style={{ animationDelay: '100ms' }}>
              ...
              <ul className="space-y-4">
                <ObjectiveItem 
                  text="Identificar intereses, talentos y valores personales para la elección vocacional." 
                  delay="0"
                />
                <ObjectiveItem 
                  text="Resaltar la importancia del bienestar emocional en las decisiones académicas y profesionales." 
                  delay="100"
                />
                <ObjectiveItem 
                  text="Guiar a los estudiantes para que vean su educación como una herramienta de transformación." 
                  delay="200"
                />
              </ul>
            </section>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 sticky top-24 animate-slide-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="space-y-6 pt-6">
                <InfoItem icon={Primero} text="21 de Octubre del 2024" />
                <InfoItem icon={Segundo} text="Dirigido a: Alumnos de diferentes semestres" />
                <InfoItem icon={Tercero} text="San Juan Bautista Tuxtepec, Oaxaca." />
                <InfoItem icon={Cuarto} text="Instalaciones: COBAO 07" />
                <InfoItem icon={Quinto} text="120 asistentes" />
