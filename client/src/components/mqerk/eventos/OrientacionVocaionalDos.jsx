...
import Uno from "../../../assets/mqerk/Fotos Estudiantes/22.webp";
import Dos from "../../../assets/mqerk/Fotos Estudiantes/23.webp";
import Tres from "../../../assets/mqerk/Fotos Estudiantes/24.webp";
...
import SieteImg from "../../../assets/mqerk/talleres/7.webp";
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-700 to-purple-800 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold animate-fade-in">
            Orientación Vocacional y Psicoeducativa: Transformar mi Educación
          </h1>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                Con ideas claras y participación activa, los estudiantes de 5º semestre del CBTis 107 de Tuxtepec 
                exploraron su vocación en un taller transformador. A través de dinámicas y metodologías centradas en el 
                autoconocimiento, la toma de decisiones académicas y profesionales, identificaron sus intereses, 
                habilidades y competencias. La sesión fue guiada por Lic. Kelvin Ramírez, quien desde MQerKAcademy 
                compartió herramientas clave para fortalecer su elección profesional y visualizar su futuro desde una 
                perspectiva consciente y estratégica.
              </p>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up" style={{ animationDelay: '100ms' }}>
              ...
              <ul className="space-y-4">
                <ObjectiveItem 
                  text="Ayudar a los estudiantes a descubrir sus intereses, talentos y valores para elegir su vocación." 
                  delay="0"
                />
                <ObjectiveItem 
                  text="Destacar la importancia del bienestar emocional al tomar decisiones sobre su futuro." 
                  delay="100"
                />
              </ul>
            </section>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 sticky top-24 animate-slide-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="space-y-6 pt-6">
                ...
                <InfoItem icon={Sexto} text="4 horas" />
          ...
          <div className="flex justify-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl w-full">
              <RelatedWorkshopCard
                ...
                description="Espacio formativo donde los estudiantes reflexionaron sobre su futuro académico y profesional, impulsando su motivación y toma de decisiones con propósito."
                date="21 de octubre"
                delay="0"
              />
              <RelatedWorkshopCard
                ...
                description="Recibimos a jóvenes ganadores en programación, reafirmando nuestro compromiso con la tecnología y la educación."
                date="22 de enero"
                delay="100"
              />
            </div>
