...
import Uno from "../../../assets/mqerk/Fotos Estudiantes/30.webp";
import Dos from "../../../assets/mqerk/Fotos Estudiantes/31.webp";
import Tres from "../../../assets/mqerk/Fotos Estudiantes/32.webp";
...
import OchoImg from "../../../assets/mqerk/talleres/8.webp";
      ...
      <div className="bg-gradient-to-br from-purple-600 via-indigo-700 to-purple-800 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold animate-fade-in">
            Gira Educativa: Educación Disruptiva, Transformando Mentes
          </h1>
        </div>
      </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up">
              ...
              <p className="text-gray-700 leading-relaxed text-justify">
                Inspirar para decidir y transformar. En una gira educativa al CBTis 107, los asesores de MQerKAcademy 
                guiaron a estudiantes de nivel medio superior en un recorrido de autoconocimiento y proyección profesional. 
                Más allá de orientarlos en la elección de una carrera, se buscó motivarles a seguir aprendiendo de forma 
                disruptiva, rompiendo esquemas tradicionales y conectando sus intereses con un propósito real. La experiencia 
                fomentó la toma de decisiones conscientes y el desarrollo de habilidades para enfrentar los retos del futuro 
            ...
            <section className="bg-white rounded-2xl shadow-md p-6 sm:p-8 animate-slide-up" style={{ animationDelay: '100ms' }}>
              ...
              <ul className="space-y-4">
                <ObjectiveItem 
                  text="Inspirar enfoques innovadores en la educación." 
                  delay="0"
                />
                <ObjectiveItem 
                  text="Compartir prácticas disruptivas que han transformado aulas." 
                  delay="100"
                />
                <ObjectiveItem 
                  text="Impulsar habilidades del siglo XXI como la colaboración, resiliencia y pensamiento crítico." 
                  delay="200"
                />
              </ul>
            </section>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md p-6 sm:p-8 sticky top-24 animate-slide-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="space-y-6 pt-6">
                <InfoItem icon={Primero} text="02 al 19 de junio del 2023" highlight />
...
function InfoItem({ icon, text, highlight = false }) {
  return (
    <div className="flex items-start gap-3 group hover:translate-x-1 transition-transform duration-300">
      ...
      <p className={`leading-relaxed text-sm ${highlight ? 'text-blue-600 font-semibold' : 'text-gray-700'}`}>
        {text}
      </p>
    </div>
  );
