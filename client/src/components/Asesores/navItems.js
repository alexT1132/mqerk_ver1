...
export const NAV_ITEMS = [
  ...
  { key: "simuladores",          label: "Simuladores",          icon: Joystick,      href: "/asesor_simuladores" },
  { key: "quizt",                label: "Quizt",                icon: ClipboardList, href: "/quizt" },
  { key: "actividades",          label: "Actividades",          icon: ListTodo,      href: "/actividades" },
  { key: "feedback",             label: "Feedback",             icon: MessageCircle, href: "/asesor_feedback" },
  { key: "correo",               label: "Correo",               icon: Mail,          href: "/correo" },
  { key: "calendario",           label: "Calendario",           icon: Calendar,      href: "/calendario" },
