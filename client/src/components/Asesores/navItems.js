...
export const NAV_ITEMS = [
  ...
  { key: "quizt",                label: "Quizt",                icon: ClipboardList, href: "/asesor/areas" },
  ...
  { key: "recursos-educativos",  label: "Recursos educativos",  icon: GraduationCap, href: "/asesor/recursos-educativos" },
