...
export default function FeedbackReview({ studentId, className = '' }){
  ...
  <section className="bg-transparent rounded-none border-0">
            ...
            pageItems.map((r, idx) => {
              ...
              return (
                <div key={`${r.id}-${idx}`}>
                  ...
                  <div className="px-0 py-3 sm:py-3 border-t border-slate-200 first:border-t-0 transition grid grid-cols-1 md:grid-cols-12 gap-4 hover:bg-slate-50">
