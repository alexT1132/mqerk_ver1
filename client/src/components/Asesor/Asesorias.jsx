    ...
    <section className="px-4 sm:px-6 lg:px-10 pt-6 xs:pt-8 sm:pt-10 md:pt-12 pb-8 max-w-screen-2xl mx-auto">
      ...
      <div className="mb-6 sm:mb-8">
        <div className="text-center mb-4 sm:mb-6">
          <h1 className="relative inline-block text-2xl xs:text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 mb-2 sm:mb-3 tracking-tight leading-[1.1]">
            <span className="inline-block pb-1">Asesorías</span>
          </h1>
        ...
        <div className="flex items-center justify-center gap-2">
          <select className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm hover:border-slate-300 transition-colors">
