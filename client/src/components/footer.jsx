        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="col-span-2 lg:col-span-1 border-t border-white/10 lg:border-none pt-6 lg:pt-0">
            ...
            <ul className="space-y-3 flex flex-col items-center lg:items-start">
              <li className="w-full">
                <a className="flex items-center lg:items-start gap-3 group text-sm text-gray-300 hover:text-white transition-colors justify-center lg:justify-start">
              ...
              <li>
                <a className="flex items-center gap-3 group text-sm text-gray-300 hover:text-white transition-colors">
