...
const ChatAdmin = () => {
    ...
    // 4. Cargar Estudiantes y Contadores
    useEffect(() => {
        loadStudents();
        loadUnreadCounts();
    ...
    return (
        <>
            <div className="flex h-[calc(100vh-8rem)] min-h-0 bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 mx-4 mb-6 mt-6 md:mt-20 pt-4 md:pt-8">
            ...
            */}
                ...
                ${selectedStudent ? 'hidden md:flex' : 'flex'} min-h-0
            `}>
                    {/* Header Sidebar */}
                    <div className="p-4 bg-white border-b border-slate-200 sticky top-0 z-10">
                        ...
                        <div className="relative group">
                            <input
                                ...
                                aria-label="Buscar por nombre o grupo"
                    ...
                    {/* Lista */}
                    <div className="flex-1 overflow-y-auto custom-scrollbar min-h-0 h-full">
                        {loading ? (
                                ...
                                {filteredStudents.map(s => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full p-4 min-h-[56px] flex items-center gap-3 transition-all duration-200 text-left relative group
                                        ...
                                        >
                                            <div className="relative shrink-0">
                                                ...
                                                {/* Badge superpuesto para asesores */}
                                                {s.tipo === 'asesor' && (
                                                    <div className="absolute -bottom-1 -right-1 bg-purple-600 text-white text-[9px] font-bold rounded-full w-6 h-6 flex items-center justify-center border-2 border-white shadow-md">
                                                        👨‍🏫
                                                    </div>
                                                )}
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className="text-xs text-slate-500 truncate flex items-center gap-1">
                                                    {s.tipo === 'asesor' ? (
                                                        <span className="bg-purple-100 text-purple-700 px-2 py-0.5 rounded text-[10px] font-semibold border border-purple-200">
                                                            👨‍🏫 Asesor
                                                        </span>
                                                    ) : (
            ...
            */}
                ...
                flex-1 w-full min-h-0 pt-0 md:pt-6 h-full
            ...
            `}>
                    {selectedStudent ? (
                        <>
                            ...
                            <div className="px-4 py-3 bg-white border-b border-slate-200 shadow-sm flex items-center justify-between z-10 sticky top-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden border border-slate-100">
                                        ...
                                        <span
                                            className="text-sm font-bold text-indigo-600 w-full h-full flex items-center justify-center"
                            ...
                            {/* Mensajes Area */}
                            <div
                                className="flex-1 overflow-y-auto p-4 md:p-6 space-y-4 bg-slate-50/50 scroll-smooth min-h-0 h-full custom-scrollbar"
                        ...
                        /* EMPTY STATE DESKTOP */
                        <div className="flex-1 hidden md:flex flex-col items-center justify-center bg-slate-50/50 min-h-0">
