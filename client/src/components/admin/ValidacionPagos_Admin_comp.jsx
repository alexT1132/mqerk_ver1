        ...
        <div className="w-full max-w-7xl xl:max-w-screen-2xl 2xl:max-w-none mx-auto">
          ...
          {!activeCategory ? (
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white rounded-lg xs:rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              {/* Tabla en todos los viewports (como en Finanzas/Solicitudes); en móvil scroll horizontal */}
              <div className="overflow-x-auto w-full">
                <table className="w-full min-w-[900px] divide-y divide-gray-200 table-fixed min-[1920px]:table-auto">
