...
const COURSE = {
  ...
  description:
    `Estudiantes de secundaria que desean ingresar con éxito a la preparatoria de su elección. A través de una metodología práctica, personalizada y basada en competencias, el curso combina conocimientos académicos con habilidades cognitivas y estrategias efectivas de estudio. Todo esto dentro de un entorno educativo innovador, flexible y sostenible con el fin de reforzar conocimientos clave y desarrollar confianza para presentar el examen de admisión con éxito.`,
  aprenderas: [
    "Técnicas para resolver reactivos de opción múltiple de forma eficiente.",
    "Estrategias de lectura y análisis de textos complejos.",
    "Fundamentos esenciales de ciencias naturales (física, química y biología).",
    "Habilidades para organizar el tiempo de estudio y mejorar la concentración.",
    "Seguridad, confianza y control del estrés antes y durante el examen.",
    "Uso de herramientas digitales para reforzar el aprendizaje.",
  ],
  areas: [
    "Entorno Social.",
