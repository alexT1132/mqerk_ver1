...
const COURSE = {
  title: "Business English Pro: comunica y destaca.",
  tagline: "Comunica, negocia y triunfa",
  modalidad: "Híbrido",
  clases: "+ 100 clases",
  ...
  description:
    `Curso especializado en inglés para los negocios, diseñado para profesionales, estudiantes y emprendedores que buscan mejorar sus habilidades de comunicación en entornos corporativos y laborales. Se centra en el uso del idioma para presentaciones, reuniones, negociaciones y la redacción de documentos formales, potenciando la confianza y la proyección profesional.`,
  aprenderas: [
    "Desarrollar vocabulario y expresiones clave del ámbito empresarial.",
    "Redactar correos electrónicos, reportes y documentos profesionales en inglés.",
    "Expresarte con seguridad en reuniones, presentaciones y entrevistas de trabajo.",
    "Comprender material corporativo como manuales, informes y propuestas.",
    "Destacar en contextos internacionales mediante una comunicación clara y efectiva.",
  ],
  areas: [
    "Vocabulario y expresiones esenciales de negocios.",
    "Comunicación efectiva en presentaciones y reuniones.",
    "Redacción de correos y documentos empresariales.",
    "Estrategias de negociación y persuasión en inglés.",
    "Comprensión y análisis de textos corporativo.",
    "Proyecto final: simulación de un entorno empresarial.",
  ],
  precio: { label: "Mensual", actual: 1575, anterior: 2100, descuento: 25 },
  incluye: [
