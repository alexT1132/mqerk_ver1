...
import Icono4 from "../../../assets/mqerk/preview/curso1/25.png";
import Icono5 from "../../../assets/mqerk/preview/curso1/26.png";
                    ...
                    {/* VIDEO Y ASESOR */}
                        ...
                        <div className="max-w-full py-4 flex justify-center items-center">
                            ...
                            <div className="max-w-4xl mx-auto p-4 space-y-6">
                                ...
                                <div className="relative border border-purple-400 rounded-md px-4 py-6">
                                    <FaQuoteLeft className="absolute -top-4 -left-3 text-black text-2xl" />
                                    <input
                                    type="text"
                                    placeholder="Escribe tu comentario"
                                    className="w-full text-sm placeholder-gray-400 outline-none bg-transparent"
                                    />
                                    <FaQuoteRight className="absolute -bottom-4 -right-3 text-black text-2xl" />
                                </div>
