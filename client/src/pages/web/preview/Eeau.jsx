        ...
        <div className="block md:hidden">
            <div className="w-full">
                <div className="preview_fondo h-180">
                    <div className="relative top-[24%] left-[43%] transform -translate-x-1/2 -translate-y-1/2 w-70">
                        <div className="flex justify-start items-center gap-2">
                            <img src={Uno} className="w-8" />
                            <p className="text-white text-[17px]">Despierta todo tu potencial.</p>
                        </div>
                        <div className="font-bold text-[35px] text-white">
                            <p>Entrenamiento para el Examen de Admisión a la Universidad</p>
                        </div>
                    ...
                    <div className="relative top-[20%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                        <h1 className="text-[#3a14a9] font-bold text-4xl">Información del curso</h1>
                    </div>
                    <div className="relative w-full top-[38%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center gap-4">
                        {/* <!-- Tarjeta 1 --> */}
                        <div className="w-full border border-[#3a14a9] text-[#3a14a9] rounded-lg bg-white shadow-md flex items-center justify-center">
                ...
                <div className="relative top-[30rem] left-[50%] transform -translate-x-1/2 -translate-y-1/2 max-w-7xl p-4 flex gap-6 items-start">
                    <div className="bg-white rounded-lg w-[100%] shadow overflow-hidden">
                        ...
                        <div className="max-w-full py-4 flex justify-center items-center">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                className="bg-[#3a14a9] text-white font-semibold px-4 py-2 rounded w-full"
                                >
                                Descripción
                                </button>
                ...
                {/* Modal */}
                    {planes && (
                        ...
                        <div className="bg-[#3c24ba] text-white w-full max-w-5xl rounded-lg px-4 py-6 relative space-y-4 overflow-y-auto max-h-[90vh]">
                            {/* Cerrar */}
                            <button
                            ...
                            {/* Encabezado */}
                            <div className="flex justify-center">
                                <div className="header-plan w-80 py-5 text-center">
                                    <h2 className="text-xl font-bold ml-10">ELIGE UN PLAN A</h2>
                                    <h2 className="text-xl font-bold ml-10 mb-2">TU MEDIDA</h2>
                                </div>
                            </div>

                            {/* Planes */}
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-23 items-stretch">
                                {/* Mensual */}
                                <div className="bg-white/10 border-2 border-white/20 rounded-xl p-6 text-sm flex flex-col justify-between">
                                    <div>
                                        <div className="mx-auto py-2 rounded-2xl bg-gradient-to-br from-[#440c83] to-[#3c24ba] text-center text-xl font-bold w-30">Mensual</div>
                                ...
                                <div className="bg-white/10 rounded-xl p-8 shadow-xl transform scale-110 text-base flex flex-col justify-between border-4 border-white">
                                    <div>
                                    <div className="mx-auto py-3 rounded-2xl bg-gradient-to-br from-[#440c83] to-[#3c24ba] text-center text-xl font-bold w-33">Start</div>
                                    <p className="text-center mt-3 leading-tight font-bold text-xl">
                                ...
                                <div className="bg-white/10 border-2 border-white/20 rounded-xl p-6 shadow-lg text-sm flex flex-col justify-between">
                                    <div>
                                    <div className="mx-auto py-2 rounded-2xl bg-gradient-to-br from-[#440c83] to-[#3c24ba] text-center text-xl font-bold w-30">Premium</div>
