...
const COURSE = {
  title: "Level Up English: aprende y aplica en la escuela",
  tagline: "Aprende hoy, aplica siempre",
  modalidad: "Híbrido",
  clases: "+ 40 clases",
  ...
  description:
    `Curso enfocado en fortalecer las habilidades de inglés de los estudiantes a través de actividades prácticas y dinámicas relacionadas con el ámbito escolar. Se busca que los alumnos adquieran confianza en la comprensión, escritura y comunicación, aplicando el idioma de forma útil en sus tareas, proyectos y presentaciones académicas.`,
  aprenderas: [
    "Comprender y utilizar vocabulario esencial para el entorno escolar.",
    "Mejorar tu pronunciación y expresión oral en inglés.",
    "Redactar textos y presentaciones académicas en inglés.",
    "Comprender instrucciones, lecturas y materiales escolares en inglés.",
    "Aplicar estrategias para comunicarte con confianza en contextos educativos.",
  ],
  areas: [
    "Fundamentos de gramática y vocabulario escolar.",
    "Comprensión lectora y análisis de textos académicos.",
    "Expresión oral y práctica de conversación.",
    "Redacción de textos y tareas en inglés.",
    "Presentaciones académicas y proyectos en inglés.",
    "Evaluación y aplicación práctica en el contexto escolar.",
  ],
  precio: { label: "Mensual", actual: 900, anterior: 1200, descuento: 25 },
  incluye: [
