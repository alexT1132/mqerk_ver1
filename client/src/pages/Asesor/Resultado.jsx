...
export const ResultadoAsesor=({area})=>{
    return(
        <>
        <Topbar/>
        <div className={`flex flex-col gap-10 justify-center items-center mx-2 my-2 sm:my-5 sm:mx-5 md:mx-10 lg:mx-20`}>
        ...
        <footer className={``}>
            <p className={`text-justify text-sm font-semibold sm:text-sm md:text-sm lg:font-thin`}>✅ ¡Felicidades! Usted ha sido aceptado para el puesto de asesor(a) educativo en el área de {area}.
